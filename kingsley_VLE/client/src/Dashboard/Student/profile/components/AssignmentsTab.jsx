...
export default function AssignmentsTab({ courseId, sectionId }) {
  ...
  const inProgress = assignments.filter((a) => {
    ...
    return (
      submittedIds.has(a.id) && submission && submission.eqaStatus !== "LOCKED"
    );
  });
                  ...
                  <table className="w-full min-w-full">
                    ...
                    <tbody className="divide-y divide-gray-200">
                      {inProgress.map((a) => {
                        ...
                        const isQualifiedPending =
                          submission?.iqaStatus === "IQA_PASSED" &&
                          submission?.eqaStatus ===
                          ...
                          <>
                            ...
                            {isExpanded && submission && (
                              <tr key={`details-${a.id}`}>
                                <td
                                  colSpan="4"
                                  className="px-4 lg:px-6 py-4 bg-gray-50"
                                >
              ...
              <div className="flex items-center gap-2 mb-4">
                ...
                >
                  ...
                  <div className="absolute left-0 mt-2 w-56 bg-gray-900 text-white text-xs rounded-lg p-3 opacity-0 group-hover:opacity-100 transition pointer-events-none group-hover:pointer-events-auto z-10 whitespace-normal">
                    These assignments have been qualified for EQA and are now
                    finalized. You cannot make any changes. These submissions
                          ...
                          <>
                            ...
                            {isExpanded && submission && (
                              <tr key={`eqa-details-${a.id}`}>
                                <td
                                  colSpan="4"
                                  className="px-4 lg:px-6 py-4 bg-purple-50"
                                >
                                  <div className="space-y-4">
                                    {/* Locked notice */}
                                    <div className="bg-purple-100 border border-purple-300 rounded-lg p-4">
                                      ...
                                      <p className="text-xs text-purple-800">
                                        This submission has been confirmed and
                                        is now locked. It is ready for external
                                        quality assurance (EQA) review. No
